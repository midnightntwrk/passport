...
export const zkConfigPath = path.join(managedPath, 'vault');
...
export async function createProviders(walletCtx: WalletContext, contractZkPath: string = zkConfigPath) {
  ...
  return {
    privateStateProvider: levelPrivateStateProvider({
      ...
      privateStateStoreName: 'contract-to-wallet-ciphertext',
      privateStoragePasswordProvider: () => 'ContractToWallet!ciphertext',
