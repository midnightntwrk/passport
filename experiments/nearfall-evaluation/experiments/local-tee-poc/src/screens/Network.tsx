    ...
    <Box flexDirection="column" gap={1}>
      ...
      {step === 'nodeUrl' && (
        <Box flexDirection="column" gap={1}>
          ...
          <Box gap={1}>
            <Text>Node URL:</Text>
            <TextInput value={nodeUrl} onChange={setNodeUrl} onSubmit={() => setStep('indexerUrl')} />
          </Box>
      ...
      {step === 'indexerUrl' && (
        <Box flexDirection="column" gap={1}>
          ...
          <Box gap={1}>
            ...
            <TextInput value={indexerUrl} onChange={setIndexerUrl} onSubmit={() => setStep('proofServerUrl')} />
          </Box>
        </Box>
      )}
      ...
      {step === 'proofServerUrl' && (
        <Box flexDirection="column" gap={1}>
          ...
          <Box gap={1}>
            ...
            <TextInput value={proofServerUrl} onChange={setProofServerUrl} onSubmit={() => setStep('confirm')} />
          </Box>
        </Box>
      )}
      ...
      {step === 'confirm' && (
        <Box flexDirection="column" gap={1}>
          ...
          <SelectInput
            ...
            onSelect={item => { if (item.value === 'save') handleSave(); else onComplete(); }}
          />
        </Box>
      )}
    </Box>
