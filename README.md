...
This repository holds the plan, the research that backs it, the reference material we build from, runnable demos, and early experiments that de-risk the cryptographic foundations.
...
├── experiments/                 Cryptographic experiments and prototypes
│   ├── account-custody-prototype/ Account-custody prototype and localnet tests
